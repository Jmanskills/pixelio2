...
function adminTab(tab) {
  ...
  // Activate the clicked tab button by matching onclick text
...
function openGiftModal(item){
  ...
  document.getElementById('gift-cost-line').textContent=`Cost: ⬡ ${item.price} (your balance: ⬡ ${profile.coins} Pixels)`;
